...
async def lifespan(app: FastAPI):
    logger.info("Starting DDJ Talks 2 Backend Server...")
    start_scheduler()
    yield

app = FastAPI(title="DDJ Talks 2 Backend", lifespan=lifespan)
...
@app.get("/api")
def read_root():
    return {"message": "DDJ Talks 2 API is running"}
...
if os.path.exists(static_path):
    ...
    def read_root_fallback():
        return {"message": "DDJ Talks 2 API is running. Web UI not built yet."}
