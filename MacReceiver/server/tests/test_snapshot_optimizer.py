...
class TestUpdateVideoHistoryArray:
    def test_appends_new_entry_to_empty_history(self):
        history = update_video_history_array(None, new_views=500, new_velocity=25.0, timestamp="2026-07-29T12:00:00+00:00", max_days=7)
        assert len(history) == 1
        assert history[0]["v"] == 500
        assert history[0]["vel"] == 25.0
        assert history[0]["t"] == "2026-07-29T12:00:00+00:00"
